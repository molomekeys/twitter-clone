...
const LoginCard = () => {
  return (
        ...
        <div className="   w-full bg-white justify-around items-center grid grid-cols-2">
            <div className="bg-transparent flex flex-col gap-10  items-center">
                <div>
               <Image  className="object-fit-cover"
               src='/twitter-Home.png' width={400} height={400} alt='logo twitter'/>
              </div>
              <h4 className="text-xl font-semibold border-b-2 border-slate-300 w-full text-center pb-2">Twitter Clone</h4>
              
             
               <div className="flex mt-4 mx-2 py-4 px-2 justify-between w-3/5  rounded-xl  text-gray-200 gap-2  text-sm">
